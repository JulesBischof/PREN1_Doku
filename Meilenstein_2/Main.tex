...
\fancypagestyle{nofooter}{
    \fancyhf{}                           % Leert Fußzeile und Kopfzeile
...
\subfile{./subfiles/Morhpologischer_Kasten_Geraet.tex} % morphologischer Kasten gesamt
\newpage

\subfile{./subfiles/beschreibung_morphologischer_kasten_pfadfinder.tex} % Beschreibung zu morphologischen Kasten Gerät
\newpage

\subfile{./subfiles/nutzwertanalyse_device.tex} % NWA Gerät
\newpage

\subsection{Simulation} % ========================================

\subfile{./subfiles/Morphologischer_Kasten_Simulation.tex} % morphologischer Kasten gesamt
\newpage

\subfile{./subfiles/beschreibung_morphologischer_kasten_simulation.tex} % Beschreibung zu morphologischen Kasten Simulator
\newpage

\subfile{./subfiles/nutzwertanalyse_simulation.tex} % NWA Simulation
\newpage



\subfile{./subfiles/risikoanalyse.tex} % Risikokram
\newpage
