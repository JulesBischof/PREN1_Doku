...
\begin{landscape} % Querformat beginnen
  ...
  \section{Evaluation der Lösungsprinzipien}\label{sec:morphologischer_Kasten}

  \subsection{Morphologischer Kasten Pfandfinder}
  ...
  \begin{tikzpicture}
    \matrix[
      ...
      column 7/.style={text width=3cm,align=center}
       ...
       & Sensorik \& Aktorik über uC, Berechnung auf HLC
       & -
       & -
       & -                                             \\
    };
  ...
  \subsection{Morphologischer Kasten Simulation}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[on background layer]
      ...
      \verbindungslinie{red}{m-1-6}{m-2-3,m-3-3,m-4-3,m-5-5,m-6-3,m-7-6,m-8-3,m-9-5,m-10-6,m-11-3,m-12-4}
    \end{scope}
  \end{tikzpicture}
  \captionof{table}{Morphologischer Kasten Simulation}\label{morphKasten}
