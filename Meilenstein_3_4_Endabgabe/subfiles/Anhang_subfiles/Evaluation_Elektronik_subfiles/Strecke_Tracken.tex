...
Der \textit{Motion Board} PCB wird ein Gyroskop auf dem verbaut haben, welcher
einer neueren Generation als der bei diesen Versuchen eingesetzten Gyroskope
entspricht (\textit{ICM42670}). Dies mit dem Grund, dass dieses Gyroskop
mittlerweile obsolet ist. Seine Art der Ansteuerung unterschiedet sich jedoch
