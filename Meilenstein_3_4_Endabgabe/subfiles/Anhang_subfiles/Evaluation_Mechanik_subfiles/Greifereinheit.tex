...
Aus der Nutzwertanalyse hat sich herauskristallisiert, dass das Konzept 1 und Konzept 2 weiterverfolgt wird.
Beim Konzept 3 ist das Risiko des Einführen des Gabelln als zu hoch bewertet.
...
Lösungen
 - mehr Zeit
 - Alternative Materialwahl als PLA (3D Druck)
...
(mehr Text!)
Aus den Testergebnissen hat sich herausgestellt, dass das Konzept 1 fehleranfälliger ist und mit mehr Zeit nicht sehr nicht gut optimiert 
werden kann. Das Konzept 2 hat ein viel geringeres Risiko und darum wird diese weiterverfolgt.
