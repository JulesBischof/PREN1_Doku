...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{./fig_Morphologischer_Kasten/Nutzwertanalyse_1.png}
    \caption{Nutzwertanalyse Gerät}~\label{fig:Nutzwertanalyse_1}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{./fig_Morphologischer_Kasten/Nutzwertanalyse_2.png}
