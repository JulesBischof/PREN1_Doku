...
\begin{table}[h]                              
    \centering
    \makebox[\textwidth][3]{ % Verschiebt nach links innerhalb der Textbreite   
...
\begin{table}[h] 
    ...
    \centering
    \makebox[\textwidth][1]{ % Verschiebt nach links innerhalb der Textbreite         
    \begin{tabular}{|c|c|c|c|c|c|c|c|}                       
        \hline
        \textbf{Endprodukt} & \textbf{Komponente}        & \textbf{Hersteller}    & \textbf{Herstellernummer}    & \textbf{Bestelldatum}     & \textbf{Anzahl}                    & \textbf{Kosten [CHF/stk]}  & \textbf{Kosten total [CHF]}   \\ \hline
                            &                            &                        &                              &                           &                                    &                            &                                 \\ \hline
                            &                            &                        &                              &                           &                                    &                            &                                 \\ \hline
                            &                            &                        &                              &                           &                                    &                            &                                 \\ \hline
                            &                            &                        &                              &                           &                                    &                            &                                 \\ \hline
